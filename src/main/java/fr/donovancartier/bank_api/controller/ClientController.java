...
public class ClientController {
    ...
    @GetMapping("/clients/{id}/accounts/{accountId}/transactions")
    public List<Transaction> accountTransactions(@PathVariable Long id, @PathVariable Long accountId){
        return transactionService.getAccountTransactions(id, accountId);
    }
